...
- 🚀 **Multi-Provider AI Support** — Now supports **Gemini**, **Groq**, and **OpenRouter** API providers. Choose your preferred AI backend during setup and easily switch between them.

---

## 🚀 Multi-Provider Support

MARK XXXIX now supports multiple AI providers, allowing you to choose the best option for your needs:

| Provider | Model | Speed | Cost | Setup |
|---|---|---|---|---|
| **Gemini** | Gemini 2.5 Flash | ⚡⚡⚡ | Free | [Get API Key](https://aistudio.google.com) |
| **Groq** | Mixtral, Llama | ⚡⚡⚡⚡ | Free | [Get API Key](https://console.groq.com) |
| **OpenRouter** | Multiple Models | ⚡⚡ | Paid | [Get API Key](https://openrouter.ai) |

During first launch, you'll be prompted to:
1. **Select your preferred AI provider**
2. **Enter the corresponding API key**
3. (Optional) **Add backup provider keys** for future switching

---

## ⚡ Quick Start

**Note:** This project requires **Python 3.11 or 3.12**.
...
**For Python 3.12 specifically (Recommended):**
```bash
...
| **API Key** | One of: Gemini (free), Groq (free), or OpenRouter (paid) |
